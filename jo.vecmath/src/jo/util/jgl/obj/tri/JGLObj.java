...
import jo.util.jgl.logic.Matrix4fLogic;
...
public class JGLObj extends JGLNode
{
    ...
    public void setVertices(Collection<?> vertices)
    {
        ...
        if (first instanceof Point3f)
        {
            ...
            setVertices((float[])ArrayUtils.toArray(vertices.toArray(), "[F"));
    }
    ...
    public void setNormals(Collection<?> normals)
    {
        ...
        if (first instanceof Point3f)
        {
            ...
            setNormals((float[])ArrayUtils.toArray(normals.toArray(), "[F"));
    }
    ...
    public void setTextures(Collection<?> textures)
    {
        ...
        if (first instanceof Point2f)
        {
            ...
            setTextures((float[])ArrayUtils.toArray(textures.toArray(), "[F"));
    }
    ...
    public void setColors(Collection<?> colors)
    {
        ...
        else if (first instanceof Tuple3f)
        {
            ...
            setColors((float[])ArrayUtils.toArray(colors.toArray(), "[F"));
    }
    ...
    {
        setIndices((short[])ArrayUtils.toArray(normals.toArray(), "[S"));
    }
