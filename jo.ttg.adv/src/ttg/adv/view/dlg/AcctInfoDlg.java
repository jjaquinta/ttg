...
import ttg.adv.logic.MoneyLogic;
...
public class AcctInfoDlg extends JDialog
{
    ...
    private void update()
    {
        ...
        mAmount.setText(
                FormatUtils.sCurrency(mAccounts.getLoanPaymentAmount()));
        mLeft.setText(String.valueOf(mAccounts.getLoanPaymentsLeft()));
        mAudit.setListData(mAccounts.getAuditTrail().toArray(new String[0]));
    }
