...
import jo.ttg.gen.imp.ui.swing.ui.IMPFrame;
import jo.util.ui.swing.logic.ColorUtils;

public class IMPSystemViewer extends SystemView
{
    public IMPSystemViewer()
    {
        initInstantiate();
        initLink();
        initLayout();
    ...
    {
        for (int x = 0; x < size.width; x += IMPFrame.STARFIELD.getWidth())
            for (int y = 0; y < size.height; y += IMPFrame.STARFIELD.getHeight())
                g.drawImage(IMPFrame.STARFIELD, x, y, null);
    }
