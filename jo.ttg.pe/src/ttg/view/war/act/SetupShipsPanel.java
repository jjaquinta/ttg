...
public class SetupShipsPanel extends HelpPanel implements TTGActionListener
{
	...
	public void init()
	{
		...
		mShips.init(ships);
		boolean build = mPanel.getGame().getGame().isAllowFleetReconfiguration();
	...
	protected void doBuild()
	{
		...
		if (cost > dosh)
		{
			mPanel.getGame().setStatus("Too expensive! Costs "+cost+" and you only have "+dosh+".");
			return;
		}
	...
	public void actionPerformed(TTGActionEvent e)
	{
		if (e.getID() == WarTTGActionEvent.DROPPED)
		{
			...
			if (obj instanceof MainWorldBean)
				world = WorldLogic.getWorld(mPanel.getGame(), (MainWorldBean)obj);
