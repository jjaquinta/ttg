    ...
    public void setObject(WorldInst obj)
    {
        ...
        else
        {
            ...
            if (mWorld.getWorld() != null)
            {
                ...
                mPoints.setText(String.valueOf(WorldLogic
                        .getHaveWorldValue(mPanel.getGame(), mWorld)));
                mPop.setText(WorldLogic.getPopulationDesc(mWorld));
                mFuel.setText(WorldLogic.getFuelDesc(mWorld));
                if (WorldLogic.isFuelDefended(mPanel.getGame(), mWorld,
                        mPanel.getSide()))
                {
                ...
                mResGen.setText(String.valueOf(WorldLogic
                        .getResourceGeneration(mPanel.getGame(), mWorld))
                        + "/turn");
                int port = mWorld.getWorld().getPopulatedStats().getUPP()
                        .getPort().getValue();
            ...
            mShips.done();
            mShips.init(WorldLogic.getVisibleShips(mPanel.getGame(), mWorld,
                    mPanel.getSide()));
        }
    }
