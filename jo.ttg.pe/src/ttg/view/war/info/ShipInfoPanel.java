...
public class ShipInfoPanel extends HelpPanel
{
	...
	public void setObject(Ship obj)
	{
		...
		else
		{
			...
			mAttack.setText(mShip.getAttack()+" ("+(mShip.getAttack()/2)+")");
			mDefense.setText(mShip.getDefense()+" ("+(mShip.getDefense()/2)+")");
			...
			mJump.setText(ShipLogic.getJumpDescription(mShip, ShipLogic.capacity(mShip)));
