	...
	protected void doProcessMouseEvent(MouseEvent e)
	{
		...
		switch (e.getID())
		{
			case MouseEvent.MOUSE_CLICKED:
				if ((e.getClickCount() == 1) && ((mw != null) || !isCanSelectEmpty()))
				{
					if (!o.equals(getFocus()) && (calcMode(o) == M_NORM))
					{
						setFocus(o);
						if (mw == null)
							fireTTGActionEvent(new TTGActionEvent(this, TTGActionEvent.SELECTED, "ord://"+o, o));				
						else
							fireTTGActionEvent(new TTGActionEvent(this, TTGActionEvent.SELECTED, mw.getURI(), mw));				
					}
				}
				else if (e.getClickCount() == 2)
				{
					...
					if (e.getButton() == MouseEvent.BUTTON1 && (mw != null))
						fireTTGActionEvent(new TTGActionEvent(this, TTGActionEvent.ACTIVATED, mw.getURI(), mw));				
					else if (e.getButton() != MouseEvent.BUTTON1)
						fireTTGActionEvent(new TTGActionEvent(this, TTGActionEvent.DEACTIVATED, mw.getURI(), mw));				
				}
				break;
			...
			case MouseEvent.MOUSE_MOVED:
				if (mw != null)
				{
					...
					if (!uri.equals(mHoverURI))
					{
						...
						fireTTGActionEvent(new TTGActionEvent(this, TTGActionEvent.HOVER, mw.getURI(), mw));				
					}
				}
				else
					mHoverURI = null;
...
//				break;
	...
	{
		mCenter = new OrdBean(getOrigin().getX() + getHexesWide()/2, getOrigin().getY() + getHexesHigh()/2, getOrigin().getZ());
	}
