...
public class CargoTableModel extends AbstractTableModel
{
	...
	{
		"Origin", "Destination", "Name", "Type",
		"Warnings", "Legality", "Best By",
		"Size", "To Buy", "To Sell",
	};
	
	private ArrayList		mCargos;
	private String			mAt;
	...
	public void setCargos(ArrayList newList)
	{
		mCargos.clear();
		if (newList != null)
	...
	{
		CargoBean cargo = (CargoBean)mCargos.get(row);
		switch (mColumns[col])
		{
			case COL_ORIGIN:
